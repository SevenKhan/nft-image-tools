...
# Script: create_demo_and_update_readme.sh
# Make sure ImageMagick is installed: sudo apt install imagemagick

# 1. GIF oluştur
cd examples/after || exit
convert -delay 50 -loop 0 *.png ../demo.gif
cd ../../ || exit

echo "Demo GIF created at examples/demo.gif"
...
echo "README.md updated with demo GIF"
